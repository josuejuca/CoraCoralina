...
<body class="">
                ...
                <div class="topbar__nav d-md-flex justify-content-between align-items-center">
                    <ul class="topbar__nav--left nav ml-md-n3">
                        <li class="nav-item"><a href="#" class="nav-link link-black-100"><i
                                    class="glph-icon flaticon-question mr-2"></i>Dúvidas?</a></li>
                        <li class="nav-item"><a href="tel:61999999999" class="nav-link link-black-100"><i
                                    class="glph-icon flaticon-phone mr-2"></i>(61) 9 9999-9999</a></li>
                    </ul>
                    ...
                    <div class="site-navigation mr-auto d-none d-xl-block">
                        <ul class="nav">
                            ...
                            <li class="nav-item"><a href="#"
                                    class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium   ">Página
                                    Inicial</a>
                            </li>
                            <li class="nav-item"><a href="#"
                                    class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium    ">Categorias</a>
                            </li>
                            <li class="nav-item"><a href="#"
                                    class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium active border-bottom border-primary border-width-2">Biblioteca
                                    Virtual</a>
                            </li>
                            <li class="nav-item"><a href="#"
                                    class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium    ">Contato</a>
                            </li>
                        ...
                        <form class="form-inline">
                            <div class="input-group">
                                ...
                                <input class="form-control bg-white-100 min-width-380 py-2d75 height-4 border-white-100"
                                    type="search" placeholder="Buscar livro" aria-label="Search">
                            </div>
    ...
    <div class="page-header border-bottom">
        <div class="container">
            <div class="d-md-flex justify-content-between align-items-center py-4">
                <h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg">Código Limpo (ID: 1)</h1>
                <nav class="woocommerce-breadcrumb font-size-2">
                    <a href="../home/index.html" class="h-primary">Home</a>
                    <span class="breadcrumb-separator mx-1"><i class="fas fa-angle-right"></i></span>
                    <a href="../shop/v1.html" class="h-primary">Livro</a>
                    <span class="breadcrumb-separator mx-1"><i class="fas fa-angle-right"></i></span>Código Limpo
                </nav>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div
                            ...
                            <figure class="woocommerce-product-gallery__wrapper pt-8 mb-0">
                                <div class="js-slick-carousel u-slick"
                                    ...
                                    <div class="js-slide">
                                        <img src="https://altabooks.com.br/wp-content/uploads/2021/07/Codigo_Limpo-scaled.jpg"
                                            style="max-width: 300px; max-height: 452px;" alt="Image Description"
                                            class="mx-auto img-fluid">
                                    </div>
                                    <div class="js-slide">
                                        <img src="https://m.media-amazon.com/images/I/91l1-PkL2ML.jpg"
                                            style="max-width: 300px; max-height: 452px;" alt="Image Description"
                                            class="mx-auto img-fluid">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-7 pl-0 summary entry-summary border-left">
                            <div class="space-top-2 px-4 px-xl-7 border-bottom pb-5">
                                <h1 class="product_title entry-title font-size-7 mb-3">Código limpo: Habilidades
                                    práticas do Agile Software</h1>
                                <div class="font-size-2 mb-4">
                                    ...
                                    <span class="ml-3">(1 avaliações)</span>
                                    <span class="ml-3 font-weight-medium"> por</span>
                                    <span class="ml-2 text-gray-600"> Robert C. Martin </span>
                                </div>
                                <p class="price font-size-22 font-weight-medium mb-3">
                                    <span class="woocommerce-Price-amount amount" style="color:green;">
                                        <span class="woocommerce-Price-currencySymbol"></span>Disponivel
                                    </span>
                                </p>
                                <div class="mb-2 font-size-2">
                                    <span class="font-weight-medium">Formato do Livro:</span>
                                    <span class="ml-2 text-gray-600">Midia Fisica & Digital</span>
                                </div>
                                    ...
                                    <div class="col-6 col-md-3 mb-3 mb-md-0">
                                        <div class="">
                                            ...
                                            <label class="border-bottom d-block checkbox-outline__label py-3 px-1 mb-0"
                                                ...
                                                <span class="" style="color:green;">Disponivel</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-6 col-md-3 mb-3 mb-md-0">
                                ...
                                <div class="woocommerce-product-details__short-description font-size-2 mb-5">
                                    ...
                                    <p class="">Robert C. “Uncle Bob” Martin é profissional em softwares desde 1970 e
                                        consultor de software desde 1990. Ele é o fundador e o presidente da Object
                                        Mentor, Inc., uma equipe de consultores experientes que orientam seus clientes
                                        no mundo todo em C++, Java, C#, Ruby, OO, Padrões de Projeto, UML, Metodologias
                                        Agile e eXtreme Programming.</p>
                                </div>
                                <form class="cart d-md-flex align-items-center" method="post"
                                    enctype="multipart/form-data">
                                    <button type="submit" name="add-to-cart" value="7145"
                                        class="btn btn-dark border-0 rounded-0 p-3 min-width-250 ml-md-4 single_add_to_cart_button button alt">Reservar
                                        Emprestimo</button>
                                    <button type="submit" name="add-to-cart" value="7145"
                                        class="btn btn-dark border-0 rounded-0 p-3 min-width-250 ml-md-4 single_add_to_cart_button button alt">Download</button>
                                </form>
                            </div>
                            <div class="px-4 px-xl-7 py-5 d-flex align-items-center">
                                <ul class="list-unstyled nav">
                                    <li class="mr-6 mb-4 mb-md-0">
                                        <a href="#" class="h-primary"><i class="flaticon-heart mr-2"></i> Adicionar aos
                                            favoritos</a>
                                    </li>
                                    <li class="mr-6">
                                ...
                                <div class="row">
                                    <div class="col-xl-8 offset-xl-2">
                                        <div
                                            ...
                                            <p class="mb-3">Mesmo um código ruim pode funcionar. Mas se ele não for
                                                limpo, pode acabar com uma empresa de desenvolvimento.</p>
                                            <p class="mb-3">Perdem-se a cada ano horas incontáveis e recursos
                                                importantes devido a um código mal escrito.
                                                Mas não precisa ser assim.</p>
                                            <p class="mb-3">O renomado especialista em software, Robert C. Martin,
                                                apresenta um paradigma revolucionário com Código limpo: Habilidades
                                                Práticas do Agile Software. Martin se reuniou com seus colegas do Mentor
                                                Object para destilar suas melhores e mais ágeis práticas de limpar
                                                códigos “dinamicamente” em um livro que introduzirá gradualmente dentro
                                                de você os valores da habilidade de um profissional de softwares e lhe
                                                tornar um programador melhor –mas só se você praticar.</p>
                                            <p class="mb-3">Que tipo de trabalho você fará? Você lerá códigos aqui,
                                                muitos códigos. E você deverá descobrir o que está correto e errado nos
                                                códigos. E, o mais importante, você terá de reavaliar seus valores
                                                profissionais e seu comprometimento com o seu ofício.</p>
                                            <p class="mb-4">A segunda parte consiste em diversos casos de estudo de
                                                complexidade cada vez maior. Cada um é um exercício para limpar um
                                                código – transformar o código base que possui alguns problemas em um
                                                melhor e eficiente. A terceira parte é a compensação: um único capítulo
                                                com uma lista de heurísticas e “odores” reunidos durante a criação dos
                                                estudos de caso.O resultado será um conhecimento base que descreve a
                                                forma como pensamos quando criamos, lemos e limpamos um código.</p>
                                            <p><b> Após ler este livro os leitores saberão:</b></p>
                                            <ul>
                                                <li>Como distinguir um código bom de um ruim</li>
                                                <li>Como escrever códigos bons e como transformar um ruim em um bom</li>
                                                <li>Como criar bons nomes, boas funções, bons objetos e boas classes
                                                </li>
                                                <li>Como formatar o código para ter uma legibilidade máxima</li>
                                                <li>Como implementar completamente o tratamento de erro sem obscurecer a
                                                    lógica</li>
                                                <li>Como aplicar testes de unidade e praticar o desenvolvimento dirigido
                                                    a testes</li>
                                            </ul>
                                            <p><b> Este livro é essencial para qualquer desenvolvedor, engenheiro de
                                                    software, gerente de projeto, líder de equipes ou analistas de
                                                    sistemas com interesse em construir códigos melhores.</b></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <table class="table table-hover table-borderless">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="">Alta Books; 1ª edição (8 setembro 2009)</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th class="px-4 px-xl-5">Dimensões :</th>
                                                            <td>16 x 2 x 23 cm</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-8 offset-xl-2">
                                        <div
                                                ...
                                                <div class="col-md-6 mb-6 mb-md-0">
                                                    <div class="d-flex  align-items-center mb-4">
                                                        ...
                                                        <div class="ml-3 h6 mb-0">
                                                            <span class="font-weight-normal">1 Avaliação</span>
                                                            <div class="text-yellow-darker">
                                                                <small class="fas fa-star"></small>
                                                                <small class="fas fa-star"></small>
                                                                <small class="fas fa-star"></small>
                                                                <small class="fas fa-star"></small>
                                                                <!-- <small class="far fa-star"></small>  Estrela vazia -->
                                                                <small class="fas fa-star"></small>
                                                                <!-- estrela completa-->
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="d-md-flex">
                                                        <button type="button"
                                                            class="btn btn-outline-dark rounded-0 px-5 mb-3 mb-md-0">Lê
                                                            todas as avaliações</button>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <ul class="list-unstyled pl-xl-4">
                                                        <li class="py-2">
                                                            <a class="row align-items-center mx-gutters-2 font-size-2"
                                                                href="javascript:;">
                                                                <div class="col-auto">
                                                                    <span class="text-dark">5 Estrelas</span>
                                                                </div>
                                                                <div class="col px-0">
                                                        ...
                                                        <li class="py-2">
                                                            <a class="row align-items-center mx-gutters-2 font-size-2"
                                                                href="javascript:;">
                                                                <div class="col-auto">
                                                                    <span class="text-dark">4 Estrelas</span>
                                                                </div>
                                                                <div class="col px-0">
                                                                    <div class="progress bg-white-100"
                                                                        style="height: 7px;">
                                                        ...
                                                        <li class="py-2">
                                                            <a class="row align-items-center mx-gutters-2 font-size-2"
                                                                href="javascript:;">
                                                                <div class="col-auto">
                                                                    <span class="text-dark">3 Estrelas</span>
                                                                </div>
                                                                <div class="col px-0">
                                                                    <div class="progress bg-white-100"
                                                                        style="height: 7px;">
                                                        ...
                                                        <li class="py-2">
                                                            <a class="row align-items-center mx-gutters-2 font-size-2"
                                                                href="javascript:;">
                                                                <div class="col-auto">
                                                                    <span class="text-dark">2 Estrelas</span>
                                                                </div>
                                                                <div class="col px-0">
                                                                    <div class="progress bg-white-100"
                                                                        style="height: 7px;">
                                                        ...
                                                        <li class="py-2">
                                                            <a class="row align-items-center mx-gutters-2 font-size-2"
                                                                href="javascript:;">
                                                                <div class="col-auto">
                                                                    <span class="text-dark">1 Estrela</span>
                                                                </div>
                                                                <div class="col px-0">
                                                                    <div class="progress bg-white-100"
                                                                        style="height: 7px;">
                                            ...
                                            <h4 class="font-size-3 mb-8">1-1 Avaliações</h4>
                                            <ul class="list-unstyled mb-8">
                                                <li class="mb-4 pb-5 border-bottom">
                                                    <div class="d-flex align-items-center mb-3">
                                                        <h6 class="mb-0">Livro é bom, mas o site é melhor</h6>
                                                    ...
                                                    <p class="mb-4 text-lh-md">Esse seria o modelo de avaliações o que
                                                        vocês acharam, vou tentar colocar avaliações das avaliações tipo
                                                        curtida das review, sera que da bom?</p>
                                                    <div class="text-gray-600 mb-4">Adicionada em 13/05/2023 </div>
                                                    <ul class="nav">
                                                        <li class="mr-7">
                                            ...
                                            <h4 class="font-size-3 mb-4">Deixe a sua avaliação</h4>
                                            <div class="d-flex align-items-center mb-6">
                                                <h6 class="mb-0">Escolha a nota (obrigatorio)</h6>
                                            ...
                                            <div class="js-form-message form-group mb-4">
                                                <label for="descriptionTextarea" class="form-label text-dark h6 mb-3">A
                                                    sua avaliação</label>
                                                <textarea class="form-control rounded-0 p-4" rows="7"
                                                    id="descriptionTextarea"
                                                    placeholder="Eai gostou do livro? conta ai a sua experiencia!"
                                                    required data-msg="Coloca pelo menos alguma coisa."
                                                    data-error-class="u-has-error"
                                                    data-success-class="u-has-success"></textarea>
                                            </div>
                                            <div class="form-group mb-5">
                                                <label for="inputCompanyName"
                                                    class="form-label text-dark h6 mb-3">Titulo da avaliação</label>
                                                <input type="text" class="form-control rounded-0 px-4"
                                                    name="companyName" id="inputCompanyName"
                                                    placeholder="Maximo 300 caracteres"
                                                    aria-label="Maximo 300 caracteres">
                                            </div>
                                            <div class="d-flex">
                                                <button type="submit"
                                                    class="btn btn-dark btn-wide rounded-0 transition-3d-hover">Enviar
                                                    avaliação</button>
                                            </div>
                ...
                <section class="space-bottom-3">
                    <div class="container">
                        <header class="mb-5 d-md-flex justify-content-between align-items-center">
                            <h2 class="font-size-7 mb-3 mb-md-0">Livros semelhantes</h2>
                        </header>
    ...
    <script src='https://d33wubrfki0l68.cloudfront.net/bundles/366d75362dce71e0cde200b63241b96aba7381ad.js'></script>
