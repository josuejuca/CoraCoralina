...
<!-- Aqui tem o parte de Login/registro -->
                            ...
                            <div class="woocommerce">
                                <div class="woocommerce-info p-4 bg-white border">Ja possui conta?
                                    <a id="sidebarNavToggler" href="javascript:;" role="button"
                                        ...
                                        data-unfold-target="#sidebarContent" data-unfold-type="css-animation"
                                        data-unfold-animation-in="fadeInRight" data-unfold-animation-out="fadeOutRight"
                                        data-unfold-duration="500"> Entre</a>
                                </div>
                                                ...
                                                <div class="row">
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-first validate-required woocommerce-invalid woocommerce-invalid-required-field"
                                                        ...
                                                        <input type="text" class="input-text form-control"
                                                            name="nome" id="billing_first_name"
                                                            placeholder="Juca" value="" autocomplete="given-name"
                                                            autofocus="autofocus">
                                                    </p>
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-last validate-required"
                                                        ...
                                                        <input type="text" class="input-text form-control"
                                                            name="telefone" id="billing_last_name"
                                                            placeholder="(61) 9 0000-0000" value=""
                                                    ...
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-first validate-required woocommerce-invalid woocommerce-invalid-required-field"
                                                        ...
                                                        <input type="text" class="input-text form-control"
                                                            name="cpf" id="billing_first_name"
                                                    ...
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-last validate-required"
                                                        ...
                                                        <input type="text" class="input-text form-control"
                                                            name="rg" id="billing_last_name"
                                                            placeholder="0.000.000" value="" autocomplete="family-name">
                                                    </p>
                                                    ...
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-last validate-required"
                                                        ...
                                                        <input type="email" class="input-text form-control"
                                                            ...
                                                            placeholder="etc.juca@gmail.com" value=""
                                                            autocomplete="email">
                                                    </p>

                                                    <p class="col-lg-6 mb-4d75 form-row form-row-last validate-required"
                                                        id="billing_email_field" data-priority="110">
                                                        <label for="billing_email" class="form-label">Data de Nascimento *</label>
                                                        <input type="date" class="input-text form-control"
                                                            name="dt_nasc" id="billing_email"
                                                            placeholder="" value=""
                                                            autocomplete="email">
                                                    </p>
                                                    ...
                                                    <p class="col-12 mb-4d75 form-row form-row-wide"
                                                        ...
                                                        <label for="billing_company" class="form-label">
                                                            Endereço</label>
                                                        <input type="text" class="input-text form-control"
                                                            name="endereco" id="billing_company" placeholder=""
                                                    ...
                                                    <p class="col-12 mb-4d75 form-row form-row-wide"
                                                        ...
                                                        <input type="password" class="input-text form-control"
                                                            name="senha" id="billing_company" placeholder=""
                                                            value="" autocomplete="organization">
                                                    </p>
