                        ...
                        <div class="row mb-6">
                            <div class="col-md-6 mb-5 mb-md-0">
                                <div class="js-form-message">
                                    ...
                                    <?php // echo $isbn; ?>
                                    <input type="text" class="form-control rounded-0" name="isbn" value="" aria-label="Jack Wayley" id="exampleFormControlInput1" required data-error-class="u-has-error" data-msg="Please enter your name." data-success-class="u-has-success">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="js-form-message">
