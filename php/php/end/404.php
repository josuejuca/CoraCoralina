...
<head>
    ...
    <title>Error 404 | Cora Coralina</title>
        ...
        <div class="container">
            <div class="space-bottom-1 space-top-xl-2 space-bottom-xl-4">
                <div class="d-flex flex-column align-items-center pt-lg-7 pb-lg-4 pb-lg-6">
                    ...
                    <h6 class="font-size-4 font-weight-medium mb-2">Coe mano tem essa página ainda não</h6>
                    <span class="font-size-2 mb-6">O Juca ainda não colocou ela no site, foi mal espera ai que jaja eu coloco</span>
