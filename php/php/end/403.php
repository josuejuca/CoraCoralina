...
<head>
    ...
    <title>Error 403 | Cora Coralina</title>
        ...
        <div class="container">
            <div class="space-bottom-1 space-top-xl-2 space-bottom-xl-4">
                <div class="d-flex flex-column align-items-center pt-lg-7 pb-lg-4 pb-lg-6">
                    ...
                    <h6 class="font-size-4 font-weight-medium mb-2">Você não pode acessar essa página, faça o login para continuar</h6>
                    <span class="font-size-2 mb-6">Caso já tenha feito o login, verifique se o seu usuário possui privilégios para acessar essa página.</span>
                    <div class="d-flex align-items-center flex-column"><a href='/'>
                            <button type="submit"
                                class="btn btn-dark rounded-0 btn-wide height-60 width-250 font-weight-medium">Voltar
                            </button>
                        </a>
                    </div>
                </div>
