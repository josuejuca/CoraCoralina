...
<head>
    ...
    <title>Usuário Cadastrado com sucesso! | Cora Coralina</title>
                                    ...
                                    <div class="p-4 p-md-6">
                                        ...
                                        <div class="form-group mb-4">
                                            <div class="js-form-message js-focus-state">
                                                ...
                                                <input type="password" class="form-control rounded-0 height-4 px-4" name="senha" id="signinPassword9" placeholder="" aria-label="" aria-describedby="signinPasswordLabel9" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2">
                                            <a href="../registrar/index.php" class="js-animation-link btn btn-block py-3 rounded-0 btn-outline-dark font-weight-medium">Criar conta</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <form action="../../controller/loginController.php" method="post" id="formlogin">
                                <div id="login" data-target-group="idForm">
                                    ...
                                    <div class="p-4 p-md-6">
                                        ...
                                        <div class="mb-2">
                                            <a href="../registrar/index.php" class="js-animation-link btn btn-block py-3 rounded-0 btn-outline-dark font-weight-medium" data-animation-in="fadeIn">Criar conta</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="container">
            <div class="space-bottom-1 space-top-xl-2 space-bottom-xl-4">
                <div class="d-flex flex-column align-items-center pt-lg-7 pb-lg-4 pb-lg-6">
                    <h6 class="font-size-4 font-weight-medium mb-2">Criação de Usúario</h6>
                    <span class="font-size-2 mb-6">Usuário Cadastrado com sucesso!</span>
                    <div class="d-flex align-items-center flex-column"><a href="javascript:;" role="button" aria-controls="sidebarContent" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-hide-on-scroll="false" data-unfold-target="#sidebarContent" data-unfold-type="css-animation" data-unfold-animation-in="fadeInRight" data-unfold-animation-out="fadeOutRight" data-unfold-duration="500">
                            <button type="submit" class="btn btn-dark rounded-0 btn-wide height-60 width-250 font-weight-medium">Entrar
                            </button>
                        </a>
                    </div>
                </div>
