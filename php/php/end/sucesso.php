...
<head>
    ...
    <link href='https://d33wubrfki0l68.cloudfront.net/bundles/6ee21e9f9d18bd23bb6a90a6425878e223079912.css'
        rel='stylesheet' />
        ...
        <div class="container">
            <div class="space-bottom-1 space-top-xl-2 space-bottom-xl-4">
                <div class="d-flex flex-column align-items-center pt-lg-7 pb-lg-4 pb-lg-6">
                    ...
                    <div class="d-flex align-items-center flex-column"><a href="javascript:;" role="button"
                            ...
                            <button type="submit"
                                class="btn btn-dark rounded-0 btn-wide height-60 width-250 font-weight-medium">Entrar
                            </button>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 mb-6 md-md-0">
                            <div class="pb-md-6">
                                <a class='d-inline-block mb-5' href='/'>
                                    <img src="https://d33wubrfki0l68.cloudfront.net/225d3ab1e310931d68973a667ef0cb6caeca8e5a/d2c63/assets/img/logo.png"
